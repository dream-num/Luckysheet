...
export default {
    ...
    userMenuItem: [{url:"www.example.com", "icon":'<i class="fa fa-folder" aria-hidden="true"></i>', "name":"Form"}, {url:"www.example.com", "icon":'<i class="fa fa-sign-out" aria-hidden="true"></i>', "name":"Sign out"}], //点击右上角的用户信息弹出的菜单
    myFolderUrl: "www.example.com", //左上角<返回按钮的链接
