...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "mapActions", function() { return vuex__WEBPACK_IMPORTED_MODULE_2__["mapActions"]; });
...
/* harmony default export */ var ChartAxisvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    if (this.lang == "ch") {
      this.setItem = cn["a" /* default */]["chartAxis"];
      return;
    }

    this.setItem = en["a" /* default */]["chartAxis"];
  },
  watch: {
    axisOption: {
