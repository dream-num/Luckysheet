...
const controlHistory = {
    redo: function (e) {
        ...
        if (ctr.type == "datachange") {
            ...
            $("#luckysheet-sheets-item" + ctr.sheetIndex).find(".luckysheet-sheets-item-name").text(ctr.oldtxt);
            ...
            if (ctr.oldcolor != null) {
                luckysheetcurrentSheetitem.append('<div class="luckysheet-sheets-item-color" style=" position: absolute; width: 100%; height: 3px; bottom: 0px; left: 0px; background-color: ' + escapeHtml(ctr.oldcolor) + ';"></div>');
            }
    ...
    undo: function () {
        ...
        if (ctr.type == "datachange") {
            ...
            $("#luckysheet-sheets-item" + ctr.sheetIndex).find(".luckysheet-sheets-item-name").text(ctr.txt);
            ...
            if (ctr.color != null) {
                luckysheetcurrentSheetitem.append('<div class="luckysheet-sheets-item-color" style=" position: absolute; width: 100%; height: 3px; bottom: 0; left: 0; background-color: ' + escapeHtml(ctr.color) + ';"></div>');
            }
