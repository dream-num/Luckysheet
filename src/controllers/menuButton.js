...
const menuButton = {
    ...
    initialMenuButton: function () {
        ...
        $("#luckysheet-icon-merge-button").click(function () {
            ...
            if (selectIsOverlap()) {
                const msg = "Cannot merge overlapping areas";
                if (isEditMode()) {
                    alert(msg);
                } else {
                    tooltip.info(msg, "");
            ...
            if (Store.config["merge"] != null) {
                ...
                if (has_PartMC) {
                    const msg = "Cannot perform this operation on partially merged cells";
                    if (isEditMode()) {
                        alert(msg);
                    } else {
                        tooltip.info(msg, "");
                        ...
                        switch (itemvalue) {
                            ...
                            case "last10%":
                                ...
                                content = `<div class="box" data-itemvalue="last10%">
                                                ...
                                                <div style="margin:5px 0;">Set as：</div>
                                                ${textCellColorHtml}
                                            </div>`;
                                break;
                            case "AboveAverage":
    ...
    fontSelectList: [],
    defualtFont: ["Times New Roman", "Arial", "Tahoma", "Verdana"],
