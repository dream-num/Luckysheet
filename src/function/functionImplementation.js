...
const functionImplementation = {
  ...
  PINYIN_XING: function() {
    ...
    try {
      var xing = pinyinUtil.getPinyin(
        func_methods
          .getFirstValue(arguments[0])
          .toString()
          .substring(0, 1)
      ).toUpperCase();
      if (xing == "0" || xing == 0) {
...
PINYIN_MING: function() {
        ...
        try {
          var ming = pinyinUtil.getPinyin(
            func_methods
              .getFirstValue(arguments[0])
              .toString()
              .substring(
                1,
                func_methods.getFirstValue(arguments[0]).toString().length
              )
          ).toUpperCase();
          if (ming == "0" || ming == 0) {
            return "";
