...
(function (p, t, e, a) {
    ...
    p.extend(i.prototype, {
        ...
        viewHtml: function () {
            ...
            if (t.selectOption.length > 0) {
                ...
                for (var i = 0; i <= t.selectOption.length - 1; i++) {
                    ...
                    if (t.pageSize === t.selectOption[i]) {
                        str += 'selected' + '>' + t.selectOption[i] + 'Row/Page</option>'
                    } else {
                        str += '>' + t.selectOption[i] + 'Row/Page</option>'
                    }
                }
                str += '</select>'
                a.push(str);
            ...
            if (t.showSkip) {
                a.push('<div class="spage-skip">Jump to&nbsp;<input type="text" class="luckysheet-mousedown-cancel" value="' + t.page + '"/>&nbsp;Page&nbsp;&nbsp;</div>')
            }
